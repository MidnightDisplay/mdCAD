...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "/Users/rodionradchenko/Documents/repos/mdCAD/.codex/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields one_liner --pick one_liner
done
```
...
```bash
ARCHIVE=$(node "/Users/rodionradchenko/Documents/repos/mdCAD/.codex/get-shit-done/bin/gsd-tools.cjs" milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
**If doesn't exist:** Create from template at `/Users/rodionradchenko/Documents/repos/mdCAD/.codex/get-shit-done/templates/retrospective.md`.
...
**Commit:**
```bash
node "/Users/rodionradchenko/Documents/repos/mdCAD/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update retrospective for v${VERSION}" --files .planning/RETROSPECTIVE.md
```
...
```bash
INIT=$(node "/Users/rodionradchenko/Documents/repos/mdCAD/.codex/get-shit-done/bin/gsd-tools.cjs" init execute-phase "1")
