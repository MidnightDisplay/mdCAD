//------------------------------------------------------------------------------
// instanced_line_shaders.h - Instanced thick line shaders for all backends
//
// GPU instanced thick line rendering with round caps.
// Uses template geometry (rectangle + semicircle caps) per line segment.
//
// Vertex attributes:
...
//   - location 3: color (vec4) - RGBA color
//
// Uniforms:
//   - mvp (mat4) - model-view-projection matrix
//   - line_width (float) - line width in world units
//   - aspect_ratio (float) - viewport width/height for correct perpendicular
//------------------------------------------------------------------------------
#ifndef INSTANCED_LINE_SHADERS_H
#define INSTANCED_LINE_SHADERS_H
