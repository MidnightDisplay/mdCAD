...
- **After every task commit:** Run `ctest --test-dir build-vulkan -C Release -R "script_roundtrip_tests\|scene_solver_diagnostics" --output-on-failure`
...
| 31-02-01 | 02 | 2 | SCRI-03 | integration | `ctest --test-dir build-vulkan -C Release -R "script_roundtrip_tests\|scene_solver_diagnostics" --output-on-failure` | ✅ | ⬜ pending |
