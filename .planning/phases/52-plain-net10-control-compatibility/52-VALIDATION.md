...
| 52-02-01 | 02 | 1 | HOSTC-01, HOSTC-02 | build smoke | `dotnet build .\samples\avalonia-host-minimal\AvaloniaHostMinimal.csproj -c Release` | `samples/avalonia-host-minimal/AvaloniaHostMinimal.csproj` | ⬜ pending |
| 52-03-01 | 03 | 2 | HOSTC-02 | regression build + unit | `dotnet test .\samples\avalonia-mdcad-control.tests\MdCad.Avalonia.Control.Tests.csproj -c Release -v minimal && dotnet build .\samples\avalonia-host\AvaloniaHost.csproj -c Release` | `samples/avalonia-host/AvaloniaHost.csproj` | ⬜ pending |
