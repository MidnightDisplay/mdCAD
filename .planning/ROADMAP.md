...
- [x] 20-03-PLAN.md — Align 17-VALIDATION with final 17-VERIFICATION closure state and record final targeted closure gate.
...
- [ ] 21-04-PLAN.md — Fix SKCH-01 Scene Hierarchy dual-entrypoint refresh defect in product code (inspector mutation invalidation wiring).
