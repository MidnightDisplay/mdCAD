...
- [ ] **Phase 6: Serializer and Save/Load Long-Tail Migration** — Migrate scene serialization math paths to cglm-backed helpers and preserve behavior.
...
Plans:
- [ ] 06-01: Map and migrate serializer math touchpoints to cglm-backed helpers
- [ ] 06-02: Add/extend harness or targeted checks for serializer parity-sensitive cases
...
Plans:
- [ ] 09-01: Expand/verify long-tail compare and harness coverage
...
|-------|----------------|--------|-----------|
| 6. Serializer and Save/Load Long-Tail Migration | 0/3 | Not started | - |
