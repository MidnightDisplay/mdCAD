# Requirements Archive: v1.3 Sketch Solver Audit + Constraint Expansion

**Archived:** 2026-04-08
**Status:** SHIPPED

For current requirements, see the active milestone requirements file (created by `/gsd-new-milestone`).
...
- [x] **ARCI-01**: User can constrain an arc-center axis relative to a line so the arc orientation follows the perpendicular-to-line authoring contract.
- [x] **ARCI-02**: User can constrain line-end and arc-end tangency at a shared point, with solver preserving tangency by moving geometric positions as needed.
- [x] **ARCI-03**: User can apply and edit an angle constraint between a single arc's start and end points.
- [x] **ARCI-04**: Advanced arc/line-arc constraints solve deterministically and surface explicit diagnostics when not satisfiable.

### Validation and Regression

- [x] **V13-01**: Developers can run automated regression coverage for trigger integrity, iterative pass behavior, and new constraint legality/solve semantics.
...
| ARCI-01 | Phase 24 | Complete |
| ARCI-02 | Phase 24 | Complete |
| ARCI-03 | Phase 24 | Complete |
| ARCI-04 | Phase 24 | Complete |
| V13-01 | Phase 25 | Complete |
