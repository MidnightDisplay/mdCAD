# Requirements Archive: v1.8 Embeddable Windows JSONL Viewer

**Archived:** 2026-05-15
**Status:** SHIPPED

No active requirements file exists until the next milestone is created with `/gsd-new-milestone`.
