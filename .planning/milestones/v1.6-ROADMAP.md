# Roadmap Archive: v1.6 Observable Flat JSONL Import for Large Geometry Dumps
...
- ✅ **v1.6 Observable Flat JSONL Import for Large Geometry Dumps** — Phases 36-40 shipped 2026-04-27
